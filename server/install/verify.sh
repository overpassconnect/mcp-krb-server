...
if [ "$SERVE_CLIENT" = no ]; then
    ...
    _cfail=0
    # The five client files, plus the page and its runtime (index.html, app.js,
    ...
    for _f in setup.sh setup.ps1 install-bridge.sh JsoncEdit.ps1 mcp-krb-bridge.py index.html app.js config.js; do
